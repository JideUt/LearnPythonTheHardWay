...
# Page 114 (PDF page 131)

# A closer look at the indexing of lists
# Lists become powerful when you can access specific elements
# remember lists are saved in order
# remember the same rules apply for strings!! (useful for files)
